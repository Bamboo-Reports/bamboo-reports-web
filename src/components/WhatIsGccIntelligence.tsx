    ...
    <div className="mx-auto max-w-6xl">
      <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16">
        <img
          ...
          height="714"
          loading="lazy"
          className="order-2 mx-auto h-auto w-full max-w-lg lg:order-1 lg:mx-0"
        />
        ...
        <div className="order-1 max-w-2xl lg:order-2">
          ...
          <p className="mt-8 text-pretty text-lg font-medium leading-relaxed text-foreground md:text-xl">
