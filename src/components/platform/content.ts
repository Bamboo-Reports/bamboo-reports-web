...
export const HERO_SHOT = {
  ...
  alt: "Bamboo Reports showing accounts, centers and prospects across data, filters and geographic views",
  width: 7680,
  height: 4800,
};
...
export const HERO_DESCRIPTION =
  "Search accounts. See every center by location. Find the decision-makers behind them. Bamboo Reports gives GTM and strategy teams the data to choose where to act next.";
...
export const STAGES: Array<{
...
}> = [
  {
    ...
    alt: "Bamboo Reports filters across account, center and prospect attributes",
    width: 5132,
    height: 4880,
  },
  {
    id: "map",
    verb: "Locate",
    headline: "See where every center operates.",
    desc: "See delivery centers by location, cluster and state. Compare where companies operate, spot concentrations and turn geography into a search criterion.",
    ...
    alt: "Bamboo Reports map: interactive cluster map and state-level heat map of delivery centers",
    width: 6080,
    height: 2728,
  },
  {
    ...
    desc: "Sort and compare accounts, centers, prospects and services in one structured view. Open any record for the detail behind the row.",
    ...
    alt: "Bamboo Reports data view with accounts, centers, prospects and services in a structured grid",
    width: 6076,
    height: 2256,
  },
  {
    ...
    desc: "Open an account to see every linked delivery center, with location, headcount and center type. Understand the company behind the logo before you make contact.",
    ...
    alt: "Bamboo Reports extended data view: an account's linked centers with headcount, location and center type",
    width: 7320,
    height: 3760,
  },
  {
...
export const PERSONAS = [
  { name: "GTM leaders & sellers", desc: "Find ICP-fit accounts, rank the right centers and give every seller a target list they can explain." },
  ...
  { name: "Staffing, RPO & talent firms", desc: "Find growing centers and reach the HR and function leaders behind their hiring demand." },
  { name: "CRE, facilities & infrastructure", desc: "Track new centers, expansions and relocations. Reach the companies creating demand in each market." },
];

export const PLATFORM_SEO = {
  title: "India GCC Intelligence Platform | Bamboo Reports",
  description:
    "Search India GCC accounts, compare delivery center locations and find the decision-makers behind them with Bamboo Reports.",
  keywords:
