          ...
          <div className="grid md:grid-cols-2 gap-8">
            {reports.map((report) => (
              <Link
                ...
                className="group"
              >
                <div className="overflow-hidden rounded-lg border bg-card hover:shadow-lg transition-shadow duration-200">
                  ...
                  <div className="p-6">
                    <h2 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors duration-200">
                      {report.title}
                    </h2>
