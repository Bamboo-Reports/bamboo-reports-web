...
const Features = () => {
  useSEO({
    title: "Features | Bamboo Reports",
    description: "Explore all Bamboo Reports features in one place.",
  });
              ...
              >
                ...
                <div className="relative flex items-start gap-4 lg:gap-6">
                  ...
                  <div className="space-y-3">
                    <h2 className="text-2xl lg:text-[2.1rem] font-black leading-tight max-w-4xl">{feature.title}</h2>
                    <p className="text-base lg:text-lg text-muted-foreground leading-relaxed max-w-4xl">{feature.description}</p>
