...
const eventDetails = [
  ...
  { icon: MapPin, label: "Venue", value: "Five-star hotel, Bengaluru", note: "Venue confirming shortly" },
];
...
const AgenticSupplyChainControlTower = () => {
  useSEO({
    ...
    description:
      "A retail roundtable hosted by Thoughtworks. A breakfast working session on moving from supply-chain signals to coordinated action: Sense. Simulate. Solve. At one of Bengaluru's five-star hotels, 10 September 2026.",
    keywords:
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t bg-background px-4 py-3 shadow-[0_-4px_16px_rgba(0,0,0,0.08)] lg:hidden">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted-foreground">Five-star hotel, Bengaluru &middot; Confirming shortly</p>
          </div>
          <a
            href="#register"
...
export default AgenticSupplyChainControlTower;
