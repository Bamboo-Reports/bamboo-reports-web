...
export const featureItems: FeatureItem[] = [
  {
    ...
    highlights: [
      ...
      "Change timelines to spot expansions, pivots, and exits as centres grow, consolidate, add capabilities, or quietly scale down."
    ],
    outcomes: [
    ...
    stats: [
      { label: "Centres tracked", value: "5,900+", helper: "Verified GCC locations across India" },
  ...
  },
  {
    ...
    outcomes: [
      ...
      "Analyst-contextualised scenarios with benchmarks that stand up in leadership and board discussions."
    ],
    stats: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Ongoing insight refinement as priorities shift, without restarting the work or re-buying static reports."
    ],
    outcomes: [
